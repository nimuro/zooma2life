...
if (!$is_member) {
    if (get_session('ss_orderview_uid') != $_GET['uid'])
        alert("직접 링크로는 주문서 조회가 불가합니다.\\n\\n주문조회 화면을 통하여 조회하시기 바랍니다.", G5_BBS_URL);
}
...
if (! (isset($od['od_id']) && $od['od_id']) || (!$is_member && md5($od['od_id'].$od['od_time'].$od['od_ip']) != get_session('ss_orderview_uid'))) {
    alert("조회하실 주문서가 없습니다.", G5_BBS_URL);
}
...
<div id="sod_fin">
        ...
        <section id="sod_fin_pay">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    ...
                    {
                    ?>
                        <a href="javascript:;" onclick="window.open('<?php echo G5_BBS_URL; ?>/taxsave.php?od_id=<?php echo $od_id; ?>', 'taxsave', 'width=550,height=400,scrollbars=1,menus=0');" class="btn_frmline">현금영수증을 발급하시려면 클릭하십시오.</a>
                    <?php } ?>
                    </td>
                </tr>
                <?php
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td><input type="text" name="noti_url" value="<?php echo G5_BBS_URL; ?>/settle_kcp_common.php"></td>
        </tr>
        </tbody>
        </table>

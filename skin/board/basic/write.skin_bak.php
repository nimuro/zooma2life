...
<section id="bo_w">
    ...
    <input type="hidden" name="wr_2" value="<?php echo $wr_2 ?>"> <!-- 콘텐츠 금액 -->
        ...
        <div id="amount_input" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="amount" value="<?php echo $write['wr_2']?>" id="amount" placeholder="최소 금액 1000원" padding: 5px>
                    <!--<input type="text" name="amount" value="" id="amount" required="" class="required frm_input" alt="최소 금액은 1000원입니다.">-->
                </td>
            </tr>
            <hr>
        </div>
        ...
        if ($gr_id == 'market' || $gr_id == 'somoim' || $gr_id == 'ebook') {
            echo("<script language='javascript'>selectClassType();</script>"); // 컨텐츠 유형 로딩

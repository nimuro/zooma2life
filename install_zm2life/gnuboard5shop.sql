...
CREATE TABLE IF NOT EXISTS `g5_shop_banner` (
  ...
  `bn_begin_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `bn_end_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `bn_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_shop_cart` (
  ...
  `ct_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `ct_select_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ct_id`),
  KEY `od_id` (`od_id`),
  KEY `it_id` (`it_id`),
...
CREATE TABLE IF NOT EXISTS `g5_shop_coupon_log` (
  ...
  `cp_price` int(11) NOT NULL DEFAULT '0',
  `cl_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`cl_id`),
  KEY `mb_id` (`mb_id`),
  KEY `od_id` (`od_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_coupon_zone` (
  ...
  `cz_datetime` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`cz_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_item_use` (
  ...
  `is_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_shop_item_qa` (
  ...
  `iq_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_shop_order` (
  ...
  `od_receipt_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `od_invoice_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `od_cash` tinyint(4) NOT NULL,
  `od_cash_no` varchar(255) NOT NULL,
  `od_cash_info` text NOT NULL, 
  `od_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,  
...
CREATE TABLE IF NOT EXISTS `g5_shop_order_delete` (
  ...
  `de_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`de_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_personalpay` (
  ...
  `pp_receipt_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  `pp_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`pp_id`),
  KEY `od_id` (`od_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `g5_shop_wish` (
  ...
  `mb_id` varchar(255) NOT NULL DEFAULT '',
  `it_id` varchar(20) NOT NULL DEFAULT '0',
  `wi_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_shop_item_stocksms` (
  ...
  `ss_send_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ss_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `g5_shop_order_post_log` (
  ...
  `ol_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,

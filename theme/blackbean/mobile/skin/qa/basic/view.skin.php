...
<article id="bo_v">
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?><li class="bo_v_prev"><a href="<?php echo $prev_href ?>"><i class="fa fa-chevron-up" aria-hidden="true"></i> 이전글 <?php echo $prev_qa_subject;?></a></li><?php } ?>
        <?php if ($next_href) { ?><li class="bo_v_next"><a href="<?php echo $next_href ?>"><i class="fa fa-chevron-down" aria-hidden="true"></i> 다음글 <?php echo $next_qa_subject;?></a></li><?php } ?>
    </ul>
    <?php } ?>
</article>
<!-- } 게시판 읽기 끝 -->

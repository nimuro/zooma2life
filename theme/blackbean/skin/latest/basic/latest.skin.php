...
<div class="lat">
    ...
    <?php for ($i=0; $i<count($list); $i++) {  ?>
        <li>
            ...
            <div class="lt_info">
            	<span class="lt_nick"><span class="sound_only">작성자</span><?php echo $list[$i]['name'] ?></span>
				<span class="lt_date"><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>           
            	<?php
            	if ($list[$i]['comment_cnt'])  echo "
            	<span class=\"lt_cmt\"><i class=\"fa fa-commenting-o\"></i> <span class=\"sound_only\">댓글</span>".$list[$i]['comment_cnt']."</span>";
            	?>
            </div>
        </li>
    <?php }  ?>

    ...
    <section id="bo_v_info">
        ...
        <div id="bo_v_top">
            ...
            <ul class="bo_v_com">
                ...
                <li>
                    <button type="button" class="btn_more_opt btn_b01 btn2" title="게시판 읽기 옵션"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 읽기 옵션</span></button>
                    <ul class="more_opt">

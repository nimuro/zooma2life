...
define('G5_TOKEN_ENCRYPTION_KEY', 'bd63033fdc3671d73aed1bd2b0738698'); // 토큰 암호화에 사용할 키
...
$g5['board_order_table'] = G5_TABLE_PREFIX.'board_order'; // 게시글 결제내역 테이블
$g5['board_order_data_table'] = G5_TABLE_PREFIX.'board_order_data'; // 게시글 결제내역 테이블
